 ...
 * @author dubavenxp
 */
public class ShoppingCar extends javax.swing.JFrame {
    ...
    private void fillJTable(){
        DefaultTableModel defaultTableModel = new DefaultTableModel(
            new String[]{"No.","Producto","Descripcion","Cantidad","Precio"}, 5);
        ...
        for (int i = 0; i < productToOrder.getProductsToOrder().size(); i++) {
            ...
            tableModel.setValueAt("Q"+ product.getPrice(), i, 4);
        }
    }
    ...
    private boolean validateInputs(){
        ...
        if(!(nameInput.getText().equals("") && totalInput.equals(""))){
            validation = true;
        }
        return validation;
    }
    ...
    private void initComponents() {
        ...
        generateOrder.setText("Generar pedido");
        generateOrder.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                generateOrderMouseClicked(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(30, 30, 30)
                    .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 729, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(generateOrder, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
